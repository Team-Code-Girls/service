...
public class UserControllerIntegrationTest {
    ...
    public void cleanUpAndAddTestData() {
        ...
        UserEntity user1 = new UserEntity("Horga Daria", 21, "dariahorga@yahoo.com", "password123", "1234567890", 0);
        UserEntity user2 = new UserEntity("Ionescu Maria", 25, "mariaionescu@yahoo.com", "password456", "9876543210", 5);
    ...
    public void testDeleteUser() throws Exception {
        ...
        mockMvc.perform(get("/users"))
                ...
                .andExpect(jsonPath("$[0].fullName").value("Ionescu Maria"));
    }
